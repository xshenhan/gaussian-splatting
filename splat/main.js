let cameras = [
    {
        ...
        height: 768,
        position: [
            -0.59522647, -0.933343, 0.05968238,
        ],
        rotation: [
            [ 0.28881097, 0.9351912, 0.20495227,],
            [-0.7127, 0.35295323, -0.606193],
            [-0.639245, 0.029003879,  0.7684559],
        ],
        fy: 722.5099,
        fx: 722.5099,
    },
...
async function main() {
    ...
    const url = new URL(
        // "nike.splat",
        // location.href,
        params.get("url") || "data/mix/gs-output/1/30000.splat",
        "http://localhost:8000",
    );
    console.log(url);
    ...
    console.log(req);
    if (req.status != 200)
        throw new Error(req.status + " Unable to load11 " + req.url);
    console.log("here");
    const rowLength = 3 * 4 + 3 * 4 + 4 + 4;
